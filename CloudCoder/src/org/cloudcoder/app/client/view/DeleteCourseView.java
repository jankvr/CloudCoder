 ...
 *
 */
public class DeleteCourseView extends Composite {
	...
	public DeleteCourseView(boolean verifyCurrentPassword) {
	...
	public void populateCourse(CourseAndCourseRegistration cc) {
		this.cc = cc;
	}
	
	public CourseAndCourseRegistration getData() {
		return cc;
	}
}
